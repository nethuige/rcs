...
(function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
			...
			html_a.push(
				sprintf('<div  class="search pull-right" style="margin-right:5px;"> ') +
				sprintf('<select id="sel_search_model" class="form-control"> ')
			);
			html_a.push(sprintf('  <option value="1">模糊匹配</option><option value="2">精确匹配</option> '));
			...
			$('#sel_search_model').change(function (event) {
			    var text_t = $('.search input').val();
			    that.searchText = text_t;
			    that.searchModel = $('#sel_search_model').val();
			    that.options.searchText = text_t;
    ...
    BootstrapTable.prototype.onSearch = function (event) {
        ...
        this.searchModel = $('#sel_search_model').val();
    ...
    BootstrapTable.prototype.initServer = function (silent, query, url) {
        var that = this,
            data = {},
             params = {
                searchModel: this.searchModel == undefined ? '' : this.searchModel,
