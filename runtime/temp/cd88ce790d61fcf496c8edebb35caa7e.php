<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"G:\EPP4\RCS\public/../application/admin\view\user\create.html";i:1489716392;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        $(function () {
            ...
            $("#form1").validate({
                ...
                submitHandler:function(){
                    ...
                    $.post("<?php echo url('user/create'); ?>",params,function(data){
                        if(data.status){
                            $("#submit-btn").attr("disabled",true);
                            toastr.success(data.msg+",正在跳转...","系统提示");
                            setTimeout(function(){location.href="<?php echo url('user/index'); ?>";},1500);
                        }else{
                                ...
                                <div class="form-group pull-left">
                                    <div class="col-md-12">
                                        <button class="btn btn-primary" id="submit-btn" type="submit">添加</button>
                                         <a href="<?php echo url('user/index'); ?>" class="btn btn-danger" type="button">
                                        <strong>返回</strong>
                                        </a>
                                    </div>
                                </div>
